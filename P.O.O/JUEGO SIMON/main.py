...
def cargar_archi(jugador,punto):
    ...
    with open("“pysimonpuntajes.json", "r") as archi:
        ...
        for i in dato1:
            ...
            fecha=i.get("Fecha")
            hora=i.get("Hora")
            dato = {"Nombre": nombre, "Puntaje":puntos, "Fecha":fecha, "Hora":hora}
            datos.append(dato)
    nombre1=jugador
    puntos1=punto
    ...
    dato = {"Nombre": nombre1, "Puntaje":puntos1, "Fecha":fecha, "Hora":hora}
    datos.append(dato)
...
def opciones():
    ...
    ventana3.geometry("20x150")
    verPuntaje=tk.Button(ventana3,text="Ver Puntajes",width=10,height=1,command=mostrar)
    salir=tk.Button(ventana3,text="X Salir X",width=10,height=1,command=cerrar)
...
if __name__=="__main__":
    ...
    boton=tk.Button(ventana1,text="Iniciar Juego",width=10,height=1,command=cerrar_ventan)
    ...
    configuracion=tk.Button(ventana2, text="opciones",width=8, height=2,command=opciones)
    bloquerojo = tk.Button(ventana2, bg="#F52300", width=20, height=7)
    bloqueazul = tk.Button(ventana2, bg="#0800F5", width=20, height=7)
    bloqueamarillo = tk.Button(ventana2, bg="#EFF224", width=20, height=7)
    bloqueverde = tk.Button(ventana2, bg="#39F500", width=20, height=7)
